...
本页由 `npm run sync` 从 `standards/domains/ptp-nmos/agents/RealtimePtpEngineer.md` 同步生成，**请勿手改**。本站不执行模型推理。
:::
...
`@standards/domains/ptp-nmos/agents/RealtimePtpEngineer.md`
