...
本页由 `npm run sync` 从 `standards/common/skills/custom/common/ai-code-boundary/SKILL.md` 同步生成，**请勿手改**。本站不执行模型推理。
:::
...
1. `@` 引用：`standards/common/skills/custom/common/ai-code-boundary/SKILL.md`
2. 或 `@` skills README 后说「使用技能 1」
