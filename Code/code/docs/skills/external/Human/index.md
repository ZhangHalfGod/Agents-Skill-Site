---
title: "Human"
description: "Detect and remove AI-sounding tone; improve natural writing"
---
...
1. `@` reference: `docs/skills/external/Human/index.md`
2. Or follow the checklist on this page (skill 11)
