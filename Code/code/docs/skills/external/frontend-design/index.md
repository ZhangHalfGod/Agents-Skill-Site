...
description: "Frontend UI design and implementation constraints"
---
...
1. `@` reference: `docs/skills/external/frontend-design/index.md`
2. Or follow the checklist on this page (skill 7)
